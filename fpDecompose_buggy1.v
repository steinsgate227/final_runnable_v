...
assign man = i[FMSB:0];
assign xz = (|exp);	// BUG 1: Inverted logic for denormalized check (should be !(|exp))
...
assign nan = &exp & !mz;
assign fract = {xz,i[FMSB:0]}; // BUG 2: Incorrect hidden bit restoration (using xz instead of !xz)
