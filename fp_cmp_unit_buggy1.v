...
wire eq = !unordered & ((az | bz) || (a==b));	// BUG 1: Logic error for zero check (using OR for bits az, bz)
wire gt1 = {xa,ma} < {xb,mb}; // BUG 2: Inverted comparison
wire lt1 = {xa,ma} > {xb,mb}; // BUG 3: Inverted comparison
