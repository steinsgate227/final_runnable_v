...
assign b0 = b < rxx;
assign r1 = b0 ? rxx + b : rxx; // BUG 1: Addition instead of subtraction in remainder
assign b1 = b < {r1,q[WID-1]};
assign r2 = b1 ? {r1,q[WID-1]} + b : {r1,q[WID-1]}; // BUG 2: Addition instead of subtraction in remainder
