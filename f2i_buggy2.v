...
wire [FMSB+1:0] man = {exp!=0,i[FMSB-1:0], 1'b0};	// BUG 1: Bit-slicing offset by one in mantissa

wire iz = i[MSB-1:0]==0;					// zero value (special)

assign overflow  = exp + zeroXp > MSB - `EXTRA_BITS;		// BUG 2: Addition instead of subtraction in overflow check
